...
<body class="bg-gray-50">
    ...
    <main class="main-content">
            ...
            <nav class="mt-4 flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-2">
                    ...
                    <li>
                        <div class="flex items-center">
                            <i class="fas fa-chevron-right text-gray-400 mx-1"></i>
                            <a href="contractualobligationrequest.php" class="ml-1 text-sm font-medium text-gray-700 hover:text-primary-600 md:ml-2"> Contractual Obligation Request</a>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="max-w-7xl mx-auto bg-white shadow-lg rounded-lg p-6 mt-4">
            <div class="text-center mb-4">
                <h1 class="text-lg font-bold">PAYROLL</h1>
                <p class="text-xs">Appendix 33</p>
            </div>
            <div class="flex flex-col md:flex-row justify-between text-xs mb-4 border-b pb-2">
                <div class="mb-2 md:mb-0">
                    <p><strong>Entity Name:</strong> LGU LALLIAN</p>
                    <p><strong>Fund/Cluster:</strong></p>
                </div>
                <div class="text-left md:text-right">
                    <p><strong>For the period:</strong> September 29, 2025</p>
                    <p><strong>Payroll No.:</strong> 1</p>
                    <p><strong>Sheet:</strong> 1 of 3 Sheets</p>
                </div>
            </div>
            ...
            <div class="payroll-table-container">
                <table class="payroll-table text-left text-gray-500 bg-blue-600" style="table-layout: fixed; width: 100%;">
                    <thead class="text-gray-700 uppercase">
                        <tr>
                            <th rowspan="2" class="w-10">#</th>
                            <th rowspan="2" class="min-w-[120px]">Name</th>
                            <th rowspan="2" class="min-w-[80px]">Position</th>
                            <th rowspan="2" class="min-w-[70px]">Address</th>
                            <th colspan="4">Compensation</th>
                            <th colspan="5">Deductions</th>
                            <th colspan="2" class="min-w-[100px]">Net Amount</th>
                            <th rowspan="2" class="min-w-[120px] text-center">Signature of Recipient</th>
                        </tr>
                        <tr>
                            <th class="min-w-[60px]">Monthly Salary/Wage</th>
                            <th class="min-w-[40px]">Other</th>
                            <th class="min-w-[50px]">Earned</th>
                            <th class="min-w-[50px]">Total</th>
                            <th class="min-w-[80px]">Gratu-ity/Terminal Leave Benefits</th>
                            <th class="min-w-[50px]">Income Tax</th>
                            <th class="min-w-[50px]">Community Tax</th>
                    ...
                    <tbody>
                        <tr id="row-1" class="bg-white border-b">
                            <td class="text-center">1</td>
                            <td>JASPER A. GARCIA</td>
                            <td>MPIO Focal Person</td>
                            <td>Mandaue</td>
                            ...
                            <td class="text-right"></td>
                            <td class="text-right">780.00</td>
                            <td class="text-right font-bold">19,220.00</td>
                            <td>9/29/2025</td>
                            <td></td>
                        </tr>
                        <tr id="row-2" class="bg-white border-b">
                            <td class="text-center">2</td>
                            <td>APRIL V. AGUAVILLA</td>
                            <td>MPIO Focal Person</td>
                            <td>Mandaue</td>
                            <td class="text-right">20,000.00</td>
                            <td class="text-right"></td>
                            ...
                            <td class="text-right font-bold">20,000.00</td>
                            <td>9/29/2025</td>
                            <td></td>
                        </tr>
                        <tr id="row-3" class="bg-white border-b">
                            <td class="text-center">3</td>
                            <td>SHERILL V. GAMBOL</td>
                            <td>Clerk</td>
                            <td>Wart OGE</td>
                            ...
                            <td class="text-right">780.00</td>
                            <td>084/1398</td>
                            <td class="text-right">1,620.00</td>
                            <td class="text-right">2,400.00</td>
                            <td class="text-right font-bold">7,600.00</td>
                            <td>9/29/2025</td>
                            <td></td>
                        </tr>
                        <tr id="row-4" class="bg-white border-b">
                            <td class="text-center">4</td>
                            <td>SNOWDON M. BOLOS</td>
                            <td>Admin. Aide</td>
                            <td>Wart OGE</td>
                            ...
                            <td class="text-right">1,620.00</td>
                            <td class="text-right">1,620.00</td>
                            <td class="text-right font-bold">5,880.00</td>
                            <td>9/29/2025</td>
                            <td></td>
                        </tr>
                        <tr id="row-5" class="bg-white border-b">
                            <td class="text-center">5</td>
                            <td>LOVELY S. SULLA</td>
                            <td>Clerk</td>
                            <td>Wart OGE</td>
                            ...
                            <td class="text-right">4,000.00</td>
                            <td class="text-right font-bold">2,000.00</td>
                            <td>9/29/2025</td>
                            <td></td>
                        </tr>
                        <tr id="row-6" class="bg-white border-b">
                            <td class="text-center">6</td>
                            <td>ROSE REEDO J. RENDON</td>
                            ...
                            <td class="text-right"></td>
                            <td class="text-right">0.00</td>
                            <td class="text-right font-bold">3,750.00</td>
                            <td>9/29/2025</td>
                            <td></td>
                        </tr>
                        <tr id="row-7" class="bg-white border-b">
                            ...
                            <td class="text-right"></td>
                            <td class="text-right">0.00</td>
                            <td class="text-right font-bold">7,500.00</td>
                            <td>9/29/2025</td>
                            <td></td>
                        </tr>
                        <tr id="row-8" class="bg-white border-b">
                        ...
                        <tr id="row-9" class="bg-white border-b">
                            <td class="text-center">9</td>
                            <td>HERMIE L. ALLARD</td>
                            <td>Administrative Aide</td>
                            <td>Wart OGE</td>
                            <td class="text-right">7,500.00</td>
                            <td class="text-right"></td>
                        ...
                        <tr id="row-10" class="bg-white border-b">
                            ...
                            <td class="text-right">5,000.00</td>
                            <td class="text-right font-bold">5,000.00</td>
                            <td>9/29/2025</td>
                            <td></td>
                        </tr>
                        <tr class="bg-gray-100 font-bold">
                            <td colspan="4" class="text-right">TOTAL AMOUNT</td>
                            <td class="text-right">90,500.00</td>
                            <td></td>
                            <td class="text-right">90,500.00</td>
                            <td class="text-right">90,500.00</td>
                            <td></td>
                            ...
                            <td></td>
                            <td class="text-right">16,020.00</td>
                            <td class="text-right">17,580.00</td>
                            <td class="text-right">72,920.00</td>
                            <td></td>
                            <td></td>
                        </tr>
                    </tbody>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs mb-8">
                <div class="section-box border border-gray-300 p-2">
                    ...
                    <div class="mt-8">
                        ...
                        <p class="text-center border-t border-gray-600">Administrative Officer IV (HRMO II)</p>
                    </div>
                    <div class="mt-2 flex justify-between">
                        <p>Date</p>
                        <p class="border-b border-gray-600 min-w-[50px]"></p>
                    </div>
                </div>
                ...
                <div class="section-box border border-gray-300 p-2">
                    ...
                    <div class="mt-2 flex justify-between">
                        ...
                        <p class="font-bold text-right border-b border-gray-600 min-w-[50px]">2,250.00</p>
                    </div>
                    <div class="mt-8">
                        <p class="font-bold text-center">ARLENE A. DE VEAS</p>
                        <p class="text-center border-t border-gray-600">Municipal Treasurer</p>
                    </div>
                    <div class="mt-2 flex justify-between">
                        <p>Date</p>
                        <p class="border-b border-gray-600 min-w-[50px]"></p>
                ...
                <div class="section-box border border-gray-300 p-2">
                    ...
                    <div class="mt-8">
                        ...
                        <p class="text-center border-t border-gray-600">Disbursing Officer</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                <div class="section-box border border-gray-300 p-2">
                    ...
                    <div class="mt-8">
                        ...
                        <p class="text-center border-t border-gray-600">Municipal Accountant</p>
                    </div>
                    <div class="mt-2 flex justify-between">
                        <p>Date</p>
                        <p class="border-b border-gray-600 min-w-[50px]"></p>
                ...
                <div class="section-box border border-gray-300 p-2">
                    ...
                    <div class="mt-8">
                        ...
                        <p class="text-center border-t border-gray-600">Municipal Mayor</p>
                    </div>
                    <div class="mt-2 flex justify-between">
                        <p>Date</p>
                        <p class="border-b border-gray-600 min-w-[50px]"></p>
                ...
                <div class="section-box border border-gray-300 p-2">
                    ...
                    <div class="mt-2">
                        <p class="font-bold">ORS/BURS No. :</p>
            ...
            <div class="mt-8 pt-4 border-t border-gray-200 print-hide">
                <div class="flex flex-col md:flex-row justify-end space-y-3 md:space-y-0 md:space-x-4">
                    ...
                    <a href="contractualobligationrequest.php" class="w-full md:w-auto">
