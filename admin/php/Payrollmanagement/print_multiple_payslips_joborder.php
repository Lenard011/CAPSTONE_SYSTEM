                    ...
                    <div class="payslip">
                        ...
                        <table class="salary-table">
                            ...
                            <tbody>
                                ...
                                <?php endif; ?>
                                <?php if (isset($employee['philhealth']) && $employee['philhealth'] > 0): ?>
                                    <tr>
                                        <td>PhilHealth Contribution</td>
                                        <td class="amount" style="color: #dc2626;"><?php echo formatCurrency($employee['philhealth']); ?></td>
                                    </tr>
                                <?php endif; ?>
                                <?php if (isset($employee['pagibig']) && $employee['pagibig'] > 0): ?>
                                    <tr>
                                ...
                                <?php if ((!isset($employee['withholding_tax']) || $employee['withholding_tax'] == 0) &&
                                    ...
                                    (!isset($employee['philhealth']) || $employee['philhealth'] == 0) &&
                                    (!isset($employee['pagibig']) || $employee['pagibig'] == 0)
                                ): ?>
                                    <tr>
